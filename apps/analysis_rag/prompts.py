...
- 근거가 부족한 내용은 단정하지 말고, "현재 확보된 데이터 기준으로는"이라고 표현하세요.
...
[내용 구성]
- 첫 문장: 얼굴형과 삼정 비율의 특징을 간단히 설명하세요.
- 두 번째 문장: 추천된 스타일들이 어떤 방향에서 적절한지 요약하세요.
- 세 번째 문장: 각 스타일의 차이를 한 문장 안에서 짧게 비교하세요.
- 근거가 부족한 스타일이 있다면 마지막에 짧게만 언급하세요.

[길이 규칙]
- 최종 답변은 3문장으로 작성하세요.
- 전체 답변은 250자 이내로 작성하세요.
- 스타일별로 문단을 나누지 마세요.
- 같은 의미를 반복하지 마세요.
